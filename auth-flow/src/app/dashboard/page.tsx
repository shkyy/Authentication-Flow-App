    ...
    return (
        <div className='min-h-screen flex flex-col bg-black text-white'>
            <header className='p-4 md:p-6 border-b border-gray-800'>
                <div className='container mx-auto flex justify-between items-center'>
                    <div className='flex items-center gap-2'>
                        <Image src={logoImg} alt="Room.me LOGO" width={120} height={120} />
                    </div>
            ...
            <main className='flex flex-grow items-center justify-center p-6'>
                <div className='max-w-lg w-full space-y-8 bg-gray-900 p-8 rounded-lg border border-gray-800 shadow-lg'>
